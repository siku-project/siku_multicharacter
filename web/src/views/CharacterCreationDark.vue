...
const progressFill = computed(() => `${(filled.value / 7) * 100}%`)
...
.field__input:focus {
  ...
  background: rgba(108, 182, 246, 0.06);
...
.segmented__item--active {
  ...
  color: #9ed0fb;
  box-shadow: inset 0 0 0 1px rgba(108, 182, 246, 0.3);
}
...
.date__popover :deep(.calendar__label) {
  font-weight: 600;
...
.date__popover :deep(.calendar__nav) {
  color: rgba(255, 255, 255, 0.4);
}

.date__popover :deep(.calendar__nav:hover) {
  background: rgba(255, 255, 255, 0.05);
  color: rgba(255, 255, 255, 0.9);
}

.date__popover :deep(.calendar__weekday) {
  color: rgba(255, 255, 255, 0.28);
}

.date__popover :deep(.calendar__day) {
  font-weight: 450;
  color: rgba(255, 255, 255, 0.8);
}

.date__popover :deep(.calendar__day:hover) {
  background: rgba(255, 255, 255, 0.06);
}

.date__popover :deep(.calendar__day--out) {
  color: rgba(255, 255, 255, 0.2);
}

.date__popover :deep(.calendar__day--selected),
.date__popover :deep(.calendar__day--selected:hover) {
  background: #6cb6f6;
...
.range::-webkit-slider-thumb {
  ...
  border-radius: 9999px;
  background: #ffffff;
  box-shadow: 0 0 10px rgba(108, 182, 246, 0.75);
}
